    ...
    return (
        <Div className=''>
            ...
            <Container className='container mx-auto flex flex-wrap px-2'>
                ...
                <ProductCard src='assets/images/product/07.jpg' productName='Fresh Green Chilis' currancy='$' price='54' discount={false} discountPrice='24' unit='kg' badge={true} badgeTitle='New' />
                <ProductCard src='assets/images/product/08.jpg' productName='Fresh Green Chilis' currancy='$' price='54' discount={false} discountPrice='24' unit='piece' badge={true} badgeTitle='New' />
                <ProductCard src='assets/images/product/09.jpg' productName='Fresh Green Chilis' currancy='$' price='54' discount={false} discountPrice='24' unit='piece' badge={false} badgeTitle='New' />
                <ProductCard src='assets/images/product/10.jpg' productName='Fresh Green Chilis' currancy='$' price='54' discount={false} discountPrice='24' unit='kg' badge={true} badgeTitle='New' />
                <ProductCard src='assets/images/product/11.jpg' productName='Fresh Green Chilis' currancy='$' price='54' discount={false} discountPrice='24' unit='kg' badge={false} badgeTitle='New' />
                <ProductCard src='assets/images/product/12.jpg' productName='Fresh Green Chilis' currancy='$' price='54' discount={false} discountPrice='24' unit='kg' badge={true} badgeTitle='New' />
                <ProductCard src='assets/images/product/13.jpg' productName='Fresh Green Chilis' currancy='$' price='54' discount={false} discountPrice='24' unit='kg' badge={false} badgeTitle='New' />
                <ProductCard src='assets/images/product/14.jpg' productName='Fresh Green Chilis' currancy='$' price='54' discount={false} discountPrice='24' unit='kg' badge={true} badgeTitle='New' />
                <ProductCard src='assets/images/product/15.jpg' productName='Fresh Green Chilis' currancy='$' price='54' discount={false} discountPrice='24' unit='kg' badge={true} badgeTitle='New' />
                <ProductCard src='assets/images/product/16.jpg' productName='Fresh Green Chilis' currancy='$' price='54' discount={false} discountPrice='24' unit='kg' badge={true} badgeTitle='New' />
