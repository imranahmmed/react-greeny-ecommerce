...
const CartSidebar = ({ cartOnClick }) => {
    return (
        <aside className='nav-sidebar w-96 h-screen fixed top-0 right-0 bg-white drop-shadow-lg sideNavShadow overflow-y-auto duration-300 z-50'>
            <Div className='relative pt-[60px] pb-[150px]'>
                <Div className='px-5 w-full text-center text-primary font-medium border-b border-border py-5 bg-chalk flex items-center justify-center absolute top-0 left-0'>
                    <GiTireIronCross className='absolute top-5 left-5 text-base text-lg cursor-pointer text-black' onClick={cartOnClick} />
